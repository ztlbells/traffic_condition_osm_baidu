...
csv_file_path      		= './ways_lat_lon.csv' #sys.argv[1]
...
def request_baidu_dir(srt_pnt_lat, srt_pnt_lon, end_pnt_lat, end_pnt_lon):
...
for line in reader :
    ...
    if line[0] != 'way_id':
    	...
    	#print line
    	result = request_baidu_dir(srt_pnt_lat, srt_pnt_lon, end_pnt_lat, end_pnt_lon)
